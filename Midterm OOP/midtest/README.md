...
```bash=
git clone git@gitea.is1ab.com:<學號>/midtest.git
git clone https://gitea.is1ab.com/<學號>/midtest.git
```
...
```
git remote set-url origin git@gitea.is1ab.com:<學號>/midtest.git
// 這行不需要
```
